...
//		String message = "Hello " + name; //OLD-WAY
		String message = helloBean.sayHello(name) + " that was called from HelloServiceImpl"; //USING HELLO-BEAN (The REST is calling the Session Bean)
